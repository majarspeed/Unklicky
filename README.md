...
| [Unklicky Z](https://github.com/majarspeed/Unklicky/tree/main/Unklicky_Endstops/Unklicky%20z) | First standard z endstop has multiple pin options. Uses the Heat set pin method and was intended to be modular and allow for customization of the pins |
| [Unklicky Sexbolt](https://github.com/majarspeed/Unklicky/edit/main/Unklicky_Endstops/Unklicky%20SexBolt/Readme.md ) | Sex bolt mod. Uses a single pin and 5mm OD chicago screw or sexbolt and 695/f695 bearing. |
| [Unklicky Sexbolt-SBS (bearing sleeve)](https://github.com/majarspeed/Unklicky/edit/main/Unklicky_Endstops/Unklicky%20SexBolt/Readme.md ) | Sex bolt mod. Uses a single pin and 5mm OD chicago screw or sexbolt. Allows the reuse of bearing sleeve from other sexbolt mods. |
| [Unklicky Sexbolt Bearing free version](https://github.com/majarspeed/Unklicky/edit/main/Unklicky_Endstops/Unklicky%20SexBolt/Readme.md ) | Sex bolt mod. Uses a single pin and 6mm OD and 5mm rod with a chicago screw or sexbolt. |
